...
public final class ViolationData {
    ...
    public static final String DRIVER_ID_MANDATORY = "driverId: Driver id is mandatory";
    ...
    public static final String PASSENGER_ID_INVALID = "passengerId: id should have uuid format";
    public static final String DRIVER_ID_INVALID = "driverId: id should have uuid format";
